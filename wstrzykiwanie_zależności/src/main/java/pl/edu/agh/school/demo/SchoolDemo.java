...
public class SchoolDemo {
    ...
    @Inject
    public SchoolDemo() {
        /**SerializableIPersistenceManager manager = new SerializableIPersistenceManager();
        manager.setClassStorageFileName("class1.dat");
        manager.setTeachersStorageFileName("teachers1.dat");
        SchoolDAO dao = new SchoolDAO(manager);*/
