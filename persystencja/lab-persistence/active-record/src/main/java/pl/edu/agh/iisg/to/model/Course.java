...
public class Course {
    ...
    public List<Student> studentList() {
        String findStudentListSql = "SELECT * FROM student JOIN student_course ON student.id = student_course.student_id" +
                " WHERE course_id = (?);";
        ...
        try {
            ...
            while(resultSet.next()){
                String firstName = resultSet.getString(Student.Columns.FIRST_NAME);
                String lastName = resultSet.getString(Student.Columns.LAST_NAME);
                int indexNumber = resultSet.getInt(Student.Columns.INDEX_NUMBER);
                int id = resultSet.getInt(Student.Columns.ID);
